<template>
  <div class="row">
    <div class="col">
      ...
      <mxm-dropdown :items="items">
        <span class="dropdown-link">
          Dropdown List
          <mxm-icon icon="angle-down" />
        </span>
      </mxm-dropdown>
    </div>
    <div class="col">
      <div class="desc">hide-on-click="false"</div>
      <mxm-dropdown :items="items" :hide-on-click="false">
        <span class="dropdown-link">
          Dropdown List
          <mxm-icon icon="angle-down" />
        </span>
...
import { type DropdownItemProps } from "mxm-ui";
