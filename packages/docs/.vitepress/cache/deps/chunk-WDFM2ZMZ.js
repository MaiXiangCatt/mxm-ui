...
function _wrapRegExp() {
  ...
  function BabelRegExp(e2, t2, p2) {
    var o2 = RegExp(e2, t2)
    return (
      r2.set(o2, p2 || r2.get(e2)),
      _setPrototypeOf(o2, BabelRegExp.prototype)
    )
  }
    ...
    (BabelRegExp.prototype[Symbol.replace] = function (t2, p2) {
      ...
      if ('function' == typeof p2) {
        ...
        return e[Symbol.replace].call(this, t2, function () {
          var e2 = arguments
          return (
            'object' != typeof e2[e2.length - 1] &&
              (e2 = [].slice.call(e2)).push(buildGroups(e2, i)),
            p2.apply(this, e2)
          )
        })
      }
...
function getDefaultCanonicalPrefix(prefixOptions) {
  ...
  if (!canonical.prefix && newCanonicalFamilies.includes(family)) {
    const validPrefix = Object.keys(styles2).find((key) =>
...
var parse = {
  icon: (icon2) => {
    ...
    if (Array.isArray(icon2) && icon2.length === 2) {
      const iconName =
        icon2[1].indexOf('fa-') === 0 ? icon2[1].slice(3) : icon2[1]
    ...
    if (
      typeof icon2 === 'string' &&
      (icon2.indexOf(''.concat(config.cssPrefix, '-')) > -1 ||
        icon2.match(ICON_SELECTION_SYNTAX_PATTERN))
    ) {
...
function convertSVG(abstractObj) {
  let params =
    arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
  const { ceFn = abstractObj.tag === 'svg' ? createElementNS : createElement } =
    params
