...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.mxm-collapse-item__header')
    contents = wrapper.findAll('.mxm-collapse-item__wapper')
  ...
  test('手风琴模式 错误处理', () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [MxmUIError: [MxmCollapse] accordion mode should only have one active item],
          ],
        ]
      `
    )
